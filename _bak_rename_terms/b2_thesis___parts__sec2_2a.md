...
时间参数决定驾驶员是否拥有足够的加工窗口。本节按 §2.1.6 三重约束模型的顺序展开：§2.2.1–2.2.2 讨论中线与零点（何时出现、按什么准则触发），§2.2.3–2.2.4 讨论出现之后的持续与动效，§2.2.5 讨论分层升级，§2.2.6 讨论上界线（可靠性与信任），§2.2.7 讨论下界线（反应时与运动学）。
